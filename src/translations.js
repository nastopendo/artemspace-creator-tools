export const translations = {
  en: {
    ...
    // Markdown Splitter
    markdownSplitterTitle: "Markdown Splitter",
    markdownSplitterDesc:
      "Split long Markdown text into chunks below a character limit for TTS (e.g. ElevenLabs), breaking at chapter and subchapter headings.",
    mdSplitterInputLabel: "Paste text or load a .md / .txt file",
    mdSplitterInputPlaceholder:
      "Paste your Markdown text here, or drop a file onto this area…",
    mdSplitterSelectFile: "Load file",
    mdSplitterClearBtn: "Clear",
    mdSplitterInputChars: "Input characters:",
    mdSplitterOptions: "Options",
    mdSplitterMaxChars: "Max characters per fragment",
    mdSplitterPauseAfterH1: "Add [pause] after chapter titles (#)",
    mdSplitterPauseAfterH2: "Add [pause] after subchapter titles (##)",
    mdSplitterPauseAfterH3: "Add [pause] after section titles (###)",
    mdSplitterPauseEndSection: "Add [pause] at the end of each section",
    mdSplitterPauseStartFragment: "Add [pause] at the beginning of each fragment",
    mdSplitterPauseEndFragment: "Add [pause] at the end of each fragment",
    mdSplitterUpperH1: "Chapter titles (#) in UPPERCASE",
    mdSplitterUpperH2: "Subchapter titles (##) in UPPERCASE",
    mdSplitterUpperH3: "Section titles (###) in UPPERCASE",
    mdSplitterStripMarkdown: "Strip Markdown syntax",
    mdSplitterSplitBtn: "Split text",
    mdSplitterEmpty: "Paste text or load a file, then click “Split text”.",
    mdSplitterFragment: "Fragment",
    mdSplitterCopy: "Copy",
    mdSplitterCopied: "Copied!",
    mdSplitterDownloadSingle: "Download single file",
    mdSplitterDownloadZip: "Download separate files (ZIP)",
    mdSplitterDownloadIndex: "Download index (chapters → fragments)",
    mdSplitterIndexTitle: "Index — chapters and their fragments",
    mdSplitterSummary: "{count} fragments · {chars} characters total",
    mdSplitterPreamble: "Intro (before first chapter)",
  ...
  pl: {
    ...
    // Markdown Splitter
    markdownSplitterTitle: "Podział tekstu (Markdown)",
    markdownSplitterDesc:
      "Dziel długi tekst Markdown na fragmenty poniżej limitu znaków pod TTS (np. ElevenLabs), zaczynając nowe fragmenty od nagłówków rozdziałów i podrozdziałów.",
    mdSplitterInputLabel: "Wklej tekst lub wczytaj plik .md / .txt",
    mdSplitterInputPlaceholder:
      "Wklej tutaj tekst w formacie Markdown lub upuść plik na to pole…",
    mdSplitterSelectFile: "Wczytaj plik",
    mdSplitterClearBtn: "Wyczyść",
    mdSplitterInputChars: "Znaki wejścia:",
    mdSplitterOptions: "Opcje",
    mdSplitterMaxChars: "Maks. znaków na fragment",
    mdSplitterPauseAfterH1: "Dodaj [pause] po tytułach rozdziałów (#)",
    mdSplitterPauseAfterH2: "Dodaj [pause] po tytułach podrozdziałów (##)",
    mdSplitterPauseAfterH3: "Dodaj [pause] po tytułach sekcji (###)",
    mdSplitterPauseEndSection: "Dodaj [pause] na końcu każdej sekcji",
    mdSplitterPauseStartFragment: "Dodaj [pause] na początku każdego fragmentu",
    mdSplitterPauseEndFragment: "Dodaj [pause] na końcu każdego fragmentu",
    mdSplitterUpperH1: "Tytuły rozdziałów (#) WIELKIMI literami",
    mdSplitterUpperH2: "Tytuły podrozdziałów (##) WIELKIMI literami",
    mdSplitterUpperH3: "Tytuły sekcji (###) WIELKIMI literami",
    mdSplitterStripMarkdown: "Usuń składnię Markdown",
    mdSplitterSplitBtn: "Podziel tekst",
    mdSplitterEmpty:
      "Wklej tekst lub wczytaj plik, a następnie kliknij „Podziel tekst”.",
    mdSplitterFragment: "Fragment",
    mdSplitterCopy: "Kopiuj",
    mdSplitterCopied: "Skopiowano!",
    mdSplitterDownloadSingle: "Pobierz jako jeden plik",
    mdSplitterDownloadZip: "Pobierz osobne pliki (ZIP)",
    mdSplitterDownloadIndex: "Pobierz spis (rozdziały → fragmenty)",
    mdSplitterIndexTitle: "Spis — rozdziały i ich fragmenty",
    mdSplitterSummary: "{count} fragmentów · {chars} znaków łącznie",
    mdSplitterPreamble: "Wstęp (przed pierwszym rozdziałem)",
